In this section, we will use Metamask (an Ethereum wallet) to deploy our contract to the Rinkeby test of the Ethereum blockchain, mint an NFT, and look at it on the NFT marketplace OpenSea.
